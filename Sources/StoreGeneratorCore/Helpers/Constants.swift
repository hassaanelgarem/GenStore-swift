...
class Constants {
    ...
    static let commandAbstract = "\(Constants.commandName) is a lightweight swift code generator for your resources."
    static let commandDiscussion = "\(Constants.commandName) can create classes for your images, colors and localized strings."
